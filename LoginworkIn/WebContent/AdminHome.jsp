   ...
   <ul class="navbar-nav ml-auto">
		 ...
		 <li class="nav-item">
     	 ...
     	 <li class="nav-item">
      			 ...
      			 <a class="nav-link dropdown-toggle" href="Subsriber.jsp" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Subscriber</a>
    			  <div class="dropdown-menu" aria-labelledby="navbarDropdown">
						...
						<a class="dropdown-item" href="#">Current Plan</a>
						<a class="dropdown-item" href="#">Circular</a>
						       
     			 </div>
   		 </li>
     	 <li class="nav-item">
    		  <a class="nav-link " href="#" id="navbarDropdown" >Verify</a>
      
   		 </li>
         <li class="nav-item">
     		 <a class="nav-link " href="#" id="navbarDropdown" >Yearly Plan</a>
      
  		  </li>
    	   <li class="nav-item">
    		  <a class="nav-link " href="#" id="navbarDropdown" >Invoice</a>
      
 		   </li>
 
   		    <li class="nav-item">
    			  <a class="nav-link " href="#" id="navbarDropdown" >Circular</a>
			  ...
			  <li class="nav-item">
    				  ...
    				  <div class="dropdown-menu" aria-labelledby="navbarDropdown">
     					   <a class="dropdown-item" href="#">Online</a>
								<a class="dropdown-item" href="#">DD or cheque</a>
	
             				 </div>
   			 </li> 
   			 <li class="nav-item">
     			 <a class="nav-link " href="#" id="navbarDropdown" >Agents</a>
    		...
    		<li class="nav-item">
     			 <a class="nav-link " href="#" id="navbarDropdown" >Mailing List</a>
   			 </li> 
